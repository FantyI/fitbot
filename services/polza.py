...
async def tryon(user_photo_bytes: bytes, item_photos_bytes: list,
    ...
    if n == 1:
        ...
        prompt = (
            ...
            "CRITICAL OUTPUT RULE: the person in the result MUST be the person from Image 1. "
            "Do NOT return Image 2 or any crop, filter or modification of Image 2. "
            "Do NOT use any person visible in Image 2 as the model. "
            ""
        ...
        prompt = (
            ...
            "TASK: generate a NEW photorealistic image of the person from Image 1 wearing all garments from Images 2 onwards, "
            "as if photographed in a single real shot with the person already dressed in the full outfit. "
            "CRITICAL OUTPUT RULE: the person in the result MUST be the person from Image 1. "
            "Do NOT return any of the garment images or their modifications. "
            "Do NOT use any person visible in Images 2+ as the model. "
            ""
